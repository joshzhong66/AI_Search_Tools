...
- 快手：支持关键词视频搜索、视频详情、一级评论、二级回复、博主资料与博主作品；官方模式使用 Actor `W0cFcwuH7hhObmnwT`。
...
浏览器访问 `http://127.0.0.1:8790`，在“API配置”页填写 Apify API Token。官方地址固定为 `https://api.apify.com/v2`。
